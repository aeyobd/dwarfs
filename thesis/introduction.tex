...
amenable to resolved, detailed studies aimed at understanding their
nature.
...
common than idealized work on the Milky Way system suggests, but the
role of numerics and assumptions in this discrepancy are unclear
...
\(R_s=0.25\,\kpc\), embedded within the inner dark matter halo. We start
the model at apocentre on an orbit with a pericentre of 20,kpc and
...
\(z'\) is the direction of orbital angular momentum, as seen from the
