...
# ╔═╡ c49dca83-48cd-4a8f-9261-9a480729e9ba
let
	modelname = "1e7_new_v31_r3.2/orbit_smallperi"
	...
	h_i = LilGuys.NFW(r_circ_max = df.r_circ_max[1], v_circ_max = df.v_circ_max[1])
	...
	h_f = LilGuys.ExpCusp(M=df.bound_mass[end], r_s=0.68)
	x = LinRange(-1, 1.5, 1000)
	r = 10 .^ x
	v = LilGuys.v_circ.(h_f, r)
	lines!(r, v*V2KMS)
