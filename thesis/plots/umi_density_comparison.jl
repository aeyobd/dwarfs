...
prof_expected = let
	prof = SurfaceDensityProfile(ENV["DWARFS_ROOT"] * "/observations/ursa_minor/density_profiles/jax_2c_eqw_profile.toml")
...
function get_stars_final(haloname, orbitname, starsname)
	modeldir = joinpath(ENV["DWARFS_ROOT"], "analysis/ursa_minor/$haloname/$orbitname/stars/$starsname/")
...
function compare_both(halo::String, orbit::String, star; lmc=false, r_j=nothing, kwargs...)
	...
	plot_stars_2d(fig[1,1], halo, orbit, star, r_b=R_h * r_j)
...
@savefig "umi_smallperi_i_f" compare_both("1e7_new_v38_r4.0", "orbit_smallperi.5", "exp2d_rs0.10",  r_j=true, norm_shift=0.0, 	break_height=-0)

# ╔═╡ 775911de-53e2-4345-880c-a627be43908b
@savefig "umi_plummer_i_f" compare_both("1e7_new_v38_r4.0", "orbit_smallperi.5", "plummer_rs0.20",  r_j=true, norm_shift=0.0,break_height=-0)

# ╔═╡ f053b7f9-f934-4cd4-ae46-32a0a373ff7e
@savefig "umi_smallperi_i_f" compare_both("1e6_v37_r5.0", "orbit_mean.2", "exp2d_rs0.10",  r_j=true, norm_shift=-0.6, 	break_height=-0)
