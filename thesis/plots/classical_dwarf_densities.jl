...
let
	...
	ax = Axis(fig[1,1], 
		ylabel = L"\log\,\Sigma\ / \ \Sigma_h",
				xticks = -2:1:1,
		limits=(nothing, nothing, -4.2, 1.1)
	...
	scatterlines!(prof_scl.log_R, prof_scl.log_Sigma, color=COLORS[1], label="Sculptor", linewidth=1, markersize=3)
	scatterlines!(prof_umi.log_R, prof_umi.log_Sigma, color=COLORS[2], label="Ursa Minor", linewidth=1, markersize=3)
	scatterlines!(prof_fornax.log_R, prof_fornax.log_Sigma, color=COLORS[3], label="Fornax", linewidth=1, markersize=3)
	...
	scatterlines!(prof_scl.log_R, prof_scl.log_Sigma .- f(prof_scl.log_R), color=COLORS[1], linewidth=1, markersize=3)
	scatterlines!(prof_umi.log_R, prof_umi.log_Sigma .- f(prof_umi.log_R), color=COLORS[2], linewidth=1, markersize=3)
	scatterlines!(prof_fornax.log_R, prof_fornax.log_Sigma .- f(prof_fornax.log_R), color=COLORS[3], linewidth=1, markersize=3)
