...
rv_distant = rv_members[rv_members.R_ell .> 7observed_properties["R_h"], :]
...
# ╔═╡ 33d79edf-7ddd-4cf1-a46f-c10f96a1750a
samples = OrderedDict(
	:best => best_stars,
...
@savefig "scl_selection" Utils.compare_j24_samples(samples, Utils.default_styles, 
	observed_properties,
	title = "Sculptor"
)
