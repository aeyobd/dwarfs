...
# ╔═╡ fb77cebd-9591-48ae-991a-5636e93e2394
x_direction = 2

# ╔═╡ 775538f0-6e2d-4136-abf6-bb1a64afaca7
y_direction = 3
...
@savefig "idealized_break_radius" let
	...
	plot_stars_2d(fig[1,2], stars_f, r_max=r_max, r_b=-r_break, orbit_direction=orbit_direction[[x_direction, y_direction]])
	...
	ModelUtils.plot_r_break_arrow!(r_b, 2.7)
	...
	ModelUtils.plot_r_break_arrow!(r_b, 0)
