...
3kpc, outside of the initial and final \(\rmax\) (see
...
opposite direction---Scl is unlikely to be an LMC satellite.
...
LMC passage modifies Scl's orbit but has otherwise little effect. The
dark matter structure evolves mildly and \(\sim 50\%\) of mass remains
bound (Table~\ref{tbl:scl_lmc_sims}).
...
distribution are resilient to tides. Any tidal effects would also be
...
loosely-bound stars, the Plummer model loses nearly 4\% of its initial
...
the inner halo structure (via the Jacobi radius).
...
Milky Way and dynamical friction imply that orbits were typically less
