...
Near to UMi, there is a small ($R_h\sim 0.5'$), likely unassociated, ultrafaint star cluster, Muñoz 1 [@munoz+2012]. The cluster is at a relative position of $(\xi, \eta) \approx(-42, -15)$  arcminutes, corresponding to an elliptical radius of 37 arcminutes. This cluster does not have a bright RGB, so has few stars brighter than a magnitude $G=22$. The cluster has little effect on the elliptically-averaged density profile (see location on [@fig:scl_observed_profiles]).
