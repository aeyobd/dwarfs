...
err_scale = 1
# these uncertanties are derived from
# transforming scl and LMC into galactocentric coordinates
# and then adding the uncertanties to SCL (in quadrature) and transforming back
# to ICRS.
err = lguys.ICRS(
    ra = err_scale*0.27,
    dec = err_scale*0.33, 
