...
% 5 {} token are mandatory
  ...
  % results heading (mandatory)
   {Tides affect neither galaxy strongly. Because the LMC perturbs Scl's orbit, Scl has few pericentres and the stellar component evolves little. UMi instead loses about 95\% of its dark matter mass, but the stars should appear unaffected. }
...
features may be lost in the noise or be of uncertain association. \emph{Gaia} now \citep{gaiacollaboration+2023} provides stellar parallaxes and proper motions, improving membership by providing key additional information.
...
including a secondary, extended spatial component.\footnotemark{} J+24 detected
...
J+24).\footnotemark{} Altogether, the J+24 method
...
\footnotetext{This
  ...
  complicating the interpretation of this purity estimate. However, we find that our conclusions are unchanged when
limiting samples to only the brightest stars. }
...
For the Scl MW+LMC model, we select, instead, the $6\sigma$ smallest pericentre with respect to the LMC, (by doubling the observed uncertainties). We only integrate this model backwards for $2\,\Gyr$.
...
NFW dark matter halo (Eq.~\ref{eq:nfw}). The NFW
...
The black lines in \ref{fig:orbits} show our selected orbits (black), representing an extreme low-pericentre orbit. We adopt these orbits as the most severe observationally-permissible tidal histories of each galaxy. 
...
indicate that {\it recent tidal effects} are likely not be observable in Scl and
UMi.
