...
outname = splitext(basename(rv_file))[1] * "_x_" * j24_sample * "_psat_j24_$psat_min"
...
# ╔═╡ 4e3278a5-f4ad-4fee-90db-cea6aaa62c4a
F_rv = obs_properties["radial_velocity"] + 5obs_properties["sigma_v"] .>  rv_meas.RV .> obs_properties["radial_velocity"] - 5obs_properties["sigma_v"]

# ╔═╡ 0314fdc7-01f9-4ed5-8b78-4b62815b6ff8
F_psat = rv_meas.PSAT .> psat_min

# ╔═╡ 733fe42e-b7a5-4285-8c73-9a41e4488d40
memb_filt = F_psat .& F_rv .&
	rv_meas.F_scatter .&
	(rv_meas.F_BEST .== 1)
...
# ╔═╡ 750ba220-8459-4c09-a9b4-ad5ac31550d0
