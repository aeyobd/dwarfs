...
# ╔═╡ 2d05364a-0612-45b9-962e-f0b29e13b599
...
# ╔═╡ 235b059e-6450-4d99-9df7-0667c2177eed
scatter(rv_meas.L_RV_SAT ./ rv_meas.L_RV_BKD, rv_meas.RV)

# ╔═╡ 31f09cc3-a783-4b4e-9c40-31cedf9b700f
mean(rv_meas.vz)
...
samples_gsr = DataFrame(sample(normal_dist(memb_stars.vz, memb_stars.RV_err, μ_min=30, μ_max=100), NUTS(0.65), MCMCThreads(), 10000, 16))

# ╔═╡ 3f9dfb6e-e4d5-4895-b8ac-f5304dd15088
@savefig "rv_sigma_corner" pairplot(samples_gsr[:, [:μ, :σ]])

# ╔═╡ 3f4e5296-fe31-4154-a449-7dfccd05d194
plot((LogNormal(2.5, 1)), axis=(; xscale=log10, xticks=Makie.automatic))
...
# ╔═╡ 71718c70-939d-4fb8-8ab3-a96fd9f034b0
Δv2 = RVUtils.rv_gsr_shift(obs_properties["ra"], obs_properties["dec"])

# ╔═╡ b6a68371-dd4d-4255-9d17-92ae458a1b9f
median(samples_gsr.μ) .+ Δv2
...
let
	...
	plot_samples!(samples_gsr, LinRange(40, 110, 100), thin=160)
	errorscatter!(midpoints(h.bins), h.values, yerror=h.err, color=COLORS[6])
...
# ╔═╡ 9d419bd5-f23d-460b-aaba-0a82c67b93de
θ_orbit
