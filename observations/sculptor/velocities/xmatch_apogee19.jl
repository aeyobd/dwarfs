...
# ╔═╡ 5a9c76ed-eccf-42d7-96f1-814471f66d89
 apogee_f = read_fits("../../all/data/allStar-dr19-1.3-apo25m.fits")
...
# ╔═╡ 8ed5161e-bdbd-4242-aebf-240c5d688cbc
apogee.source_id

# ╔═╡ bfb22331-51d6-46d4-810e-ab49f4ee9f99
md"""
- 5007614108275662976
- 2699647877685047808
...
# ╔═╡ 7915a039-bb0d-4f05-a4e8-1446ddc1a965
...
write_fits( "processed/apogee19_xmatch.fits", good, overwrite=true)
...
# ╔═╡ c89af488-7800-4b9e-ae2f-9faa5823e907
 apogee_allvisit = read_fits("../../all/data/allVisit-dr19-1.3-apo25m.fits")
...
write_fits("processed/apogee19_allvisit_xmatch.fits", allvisit, overwrite=true)
