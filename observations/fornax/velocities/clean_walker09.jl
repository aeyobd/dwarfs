...
j24 = read_fits("../data/jensen+24_1c.fits")

# ╔═╡ ea398623-ebc2-420a-8377-65bef43c0154
begin 
	walker09_single = read_fits("$walker_dir/walker+09_observations.fits") 
...
begin 
	walker09_averaged = read_fits("$walker_dir/walker+09_summary.fits")
...
sum(walker09_averaged.Galaxy .== "For")
...
begin
	...
	_walker_filt = walker09_all.Galaxy .== "For"
