...
outname = splitext(basename(rv_file))[1] * "_psat_$psat_min"
...
obs_properties = TOML.parsefile(ENV["DWARFS_ROOT"] * "/observations/fornax/observed_properties.toml")
...
# ╔═╡ 2e3989f2-aec1-454f-9da3-b8ab7dac5d40
...
let
	...
	scatter!(nonmemb_stars.R_ell, nonmemb_stars.RV)
