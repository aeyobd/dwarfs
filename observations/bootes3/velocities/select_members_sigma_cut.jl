...
# ╔═╡ 79184751-0423-460c-bf76-46c3c4949a4b
begin 
...
outname = splitext(basename(rv_file))[1] * "_x_" * j24_sample * "_sigma_$nsigma"
...
# ╔═╡ 1326220d-4809-4fdd-bb1d-081cc82112d6
F_sigma = abs.(rv_meas.RV .- obs_properties["radial_velocity"]) .< nsigma*obs_properties["sigma_v"]

# ╔═╡ 733fe42e-b7a5-4285-8c73-9a41e4488d40
memb_filt =   F_sigma .& rv_meas.F_scatter

# ╔═╡ cc6c65db-ef57-4745-8ada-e11427274a77
memb_stars = rv_meas[memb_filt, :]

# ╔═╡ aa3e540b-886a-408f-88d6-40825574e8b8
memb_stars_alt = read_fits("processed/rv_deimos_x_2c_psat_0.2.fits")

# ╔═╡ 4f9d0501-888e-4f0d-b6ce-5a21793575ca
memb_stars_default = rv_meas[rv_meas.P_SAT_deimos .> 0.5, :]

# ╔═╡ e9468ed1-50f0-4e50-9523-5a25574de900
 sort(memb_stars_alt.source_id) .∈ [sort(memb_stars_default.source_id)]
...
nonmemb_stars = rv_meas[(.!F_sigma) .& rv_meas.F_scatter, :]
