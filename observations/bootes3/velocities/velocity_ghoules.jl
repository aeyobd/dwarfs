...
# ╔═╡ e4d5406e-ddcd-4b74-81c0-afd25f73f714
using DataFrames
...
rv_meas = let
	df = read_fits("processed/$rv_file")

	append!(df, Dict(:RV=>190, :RV_err=>0.5), cols=:union)
	append!(df, Dict(:RV=>190.5, :RV_err=>0.5), cols=:union)
	append!(df, Dict(:RV=>191, :RV_err=>0.5), cols=:union)
	df
end
