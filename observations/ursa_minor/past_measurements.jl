...
md"""
# Observations of Ursa Minor

A quick collection of past literature observations and measurments of the Ursa Minor DSph
"""
...
muñoz2018 = Dict(
	:study => "Muñoz+18",
	:ra => 227.2420 ± 1.07 / 3600 * 360 / 24, # seconds to arcseconds
	:dec => 67.2221 ± 5.7/ 3600,
	:L => 10 .^ (5.546 ± 0.020) * u"Lsun", # derived from Mv=−9.03 ± 0.05
	:PA => 50 ± 1, # for exponential, includes several others
	:ell => 0.55 ± 0.01,
	:r_h => 18.2 ± 0.1
)
...
# ╔═╡ 00ca97b6-6ff4-457f-a1a2-e519aa9842a3
md"""
## Pace + 2020
"""

# ╔═╡ ca71c8fd-70cf-4b16-a4d2-fceff7f2abc3
pace2020 = Dict(
	:study => "pace+20",
	:radial_velocity => -244.7 ± 0.3,
	:σ_v => 8.7 ± 0.3,
	:pmra => -0.151 ± 0.014,
	:pmdec => 0.065 ± 0.013,
)
...
# ╔═╡ 670f324e-936a-4ad0-8a44-4be351fc2fb7
σpm_sys_gdr3 = 0.017

# ╔═╡ cde8a009-958e-4511-be4f-b903913e6b49
mv2020a = Dict(
	:study => "MV2020a", 
	:pm_ra => -0.124 ± σpm_sys_gdr3,
	:pm_dec => 0.078 ± σpm_sys_gdr3,
)
...
md"""
## Garofalo + 2024
RRL distance estimate. See comparison with literature in the paper.
"""

# ╔═╡ 98fe3c7a-2ee8-4600-a8d4-eacb4bd78054
garofalo2024 = Dict(
	:study => "Garofalo+24",
	:distance => dm_to_d(19.23 ± 0.09),
)
...
compare_measurements(:radial_velocity, "radial velocity",)

# ╔═╡ a3c6615c-fb23-4692-a04b-f4e327faf9cb
compare_measurements(:σ_v, "velocity dispersion")
...
manifest_format = "2.0"
project_hash = "d76b5661ebd51b76ddcf3b5b383eb46f7adfb4c1"
...
[[deps.Arya]]
deps = ["ColorSchemeTools", "Colors", "DensityEstimators", "DocStringExtensions", "Makie", "MakieCore", "StatsBase", "TOML", "Test"]
git-tree-sha1 = "7584b08518757b3c49486b25b987e302d87c7380"
...
[[deps.DensityEstimators]]
deps = ["DocStringExtensions", "IntervalSets", "NearestNeighbors", "QuadGK", "Random", "SpecialFunctions", "StatsBase"]
git-tree-sha1 = "52e86f307da6ce287cd59d2c6f552f70a0d2d622"
uuid = "6a64a12f-920b-4cea-9d97-f6c2170ce0ee"
version = "0.1.1-DEV-3"
