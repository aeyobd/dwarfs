...
#define MAX_ANCHORS         10000
#define MAX_INTERPTABLE     1001
...
#define PLUMMER 1
#define HERNQUIST 2
#define SPHERICALEXPDISC 3
#define CUSTOMTABLE 4
#define ISOTHERMAL 5
#define MIYAMOTONAGAI 6				/* James Lane added 04/27 */
#define MILKYWAY 7				/* James Lane added 05/19 */
#define MWPOTENTIAL2014 8			/* James Lane added 07/26 */
#define RAPHAMW 9			/* RE 01/20 */
#endif
#ifdef PERT_TIMEDEP
#define LINEAR 0
#endif
...
extern struct global_data_all_processes
{
  ...
  int pert_interp_nfiles;
  char pert_interp_fbase[MAXLEN_FILENAME];
  double pert_interp_r[MAX_INTERPTABLE];
  double pert_interp_t[MAX_INTERPTABLE];
  int pert_t_index;
  double pert_interp_M[MAX_INTERPTABLE][MAX_INTERPTABLE];
  ...
  double pert_M;				
  double pert_a;	
  double pert_b;				/* end James Lane added 04/27 */
  ...
  double pert_b;
  double pert_c;
  double pert_d;				/* end James Lane added 05/19 */
  #elif PERT_PROFILE == MWPOTENTIAL2014		/* begin James Lane added 07/26 */
  double pert_Md;
  double pert_Mb;
  double pert_Mhvir;
  double pert_a;
  ...
  double pert_d;
  double pert_conc;
  double pert_alpha;				/* end James Lane added 07/26 */


  #elif PERT_PROFILE == RAPHAMW	/* begin RE added 01/20 */
  double pert_Md_thin;
  double pert_Md_thick;
  double pert_Mb;
  double pert_abulge;
  double pert_a_thin;
  double pert_a_thick;
  ...
  int n_anchors;
  char anchor_file[MAXLEN_FILENAME];
  double amp_anchors[MAX_ANCHORS];
  double t_anchors[MAX_ANCHORS];
  #endif
  #endif
}
...
extern struct particle_data
{
  ...
  FLOAT PertAccel[3];           /*!< particle acceleration due to perturbation */
#ifdef PMGRID
