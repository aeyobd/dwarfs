...
# ╔═╡ 86dd7038-5cc8-11ef-08ae-25a047375d07
using DataFrames: DataFrame

# ╔═╡ bde83a6f-ec06-4678-9ca8-d105f948e2da
using CairoMakie, Arya

# ╔═╡ c265af54-30d5-47ad-bf26-aaf826fe9126
include("../data/MIST_v1.2_vvcrit0.4_UBVRIplus/read_iso.jl")

# ╔═╡ 79377957-3292-40f0-a8be-dd2aa80934cf
filename = "../data/MIST_v1.2_vvcrit0.4_UBVRIplus/MIST_v1.2_feh_m3.00_afe_p0.0_vvcrit0.4_UBVRIplus.iso.cmd"

# ╔═╡ a1f449ad-34ff-4d56-ba79-5368f2411dd3
cmd = ISOCMD(filename)

# ╔═╡ 0b1e72b2-05a2-48f2-b48c-62311d6b0aef
iso = cmd[9.6]

# ╔═╡ 51c2b73a-0aa6-4d97-a088-68e15bd0decd
iso_filt = iso.phase .<= 3 # includes HB

# ╔═╡ 4ac8aa29-360e-4b04-9f88-868ffd98f935
lines(iso.Gaia_BP_EDR3[iso_filt] .- iso.Gaia_RP_EDR3[iso_filt], iso.Gaia_G_EDR3[iso_filt], 
	axis=(; xlabel="BP-RP", ylabel="G", yreversed=true)
)
...
manifest_format = "2.0"
project_hash = "8385e60b0c26a5cd86358712073f6971c4a1ce8c"
...
deps = ["DocStringExtensions", "NearestNeighbors", "QuadGK", "Random", "SpecialFunctions", "StatsBase"]
git-tree-sha1 = "59cffb452a2ca337a52050cf0471acdca230e5ec"
