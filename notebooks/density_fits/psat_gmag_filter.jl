...
let 
	...
	xi_p, eta_p = lguys.shear_points_to_ellipse(xi, eta, params.ecc, params.PA)
...
let 
	...
	scatter!(xi, eta, markersize=3, alpha=0.05, color=:black)
...
let
	...
	plot_density!(ax, all_stars[filt, :], label="simple cuts")
