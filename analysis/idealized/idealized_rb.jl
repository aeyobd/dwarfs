...
# ╔═╡ bebc324a-33f4-469a-8da8-30f384eb2bb1
...
# ╔═╡ 5078610b-aaf5-47a0-b828-93731f3c31a1
function plot_density_i_f(gs = Figure()[1,1])
	ax = Axis(gs,
		limits = (-1.5, 2.0, -0, 8),
		xlabel = L"log $R$ / kpc",
...
# ╔═╡ ffb3b6e6-41b8-4c68-b074-0f95f8b9e501
plot_density_i_f(); 	Makie.current_figure()
...
@savefig "idealized_break_radius" let
	fig = Figure(size=(5.5*72, 5.5*72))



	ax = plot_density_i_f(fig[1,1])
	ax_v = Axis(fig[2,1],
		xlabel=L"log $R$ / kpc",
