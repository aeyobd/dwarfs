...
# stellar_profiles.jl $out_path $stars_file -o $1/stellar_profiles.hdf5 --bin-method equal-number


project_snapshot.jl $out_path $stars_file $1/final.fits -i $idx_f
stellar_profile.jl $1/final.fits --mass-column probability -s --bin-method equal-number

project_snapshot.jl $out_path $stars_file $1/initial.fits -i 1 --distance $dist
stellar_profile.jl $1/initial.fits --mass-column probability -s --bin-method equal-number
