...
sim_dir = ENV["DWARFS_ROOT"] * "/simulations/sculptor/mc_orbits/vasiliev_heavylmc/"
...
begin 
	out = lguys.Output("../vasiliev_heavylmc/");

	df_peris_apos = lguys.read_fits("../vasiliev_heavylmc/peris_apos.fits")
...
# ╔═╡ 7d4807ce-13b4-4665-82d9-4790f1d4877c
mkdir("figures")
