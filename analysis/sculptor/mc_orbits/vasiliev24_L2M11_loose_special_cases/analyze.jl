...
sim_dir = ENV["DWARFS_ROOT"] * "/simulations/sculptor/mc_orbits/vasiliev24_L2M11_loose_special_cases/"
...
begin 
	out = lguys.Output("../vasiliev24_L2M11_loose/");

	df_peris_apos = lguys.read_fits("../vasiliev24_L2M11_loose/peris_apos.fits")
...
let
	...
	fig = lguys.plot_xyz(positions_scl_lmc..., labels=orbit_labels)
