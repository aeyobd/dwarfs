...
# ╔═╡ 6433f052-a607-45b1-9a82-5119f3f99c28
using LilGuys

# ╔═╡ f99df674-224e-4a52-ab45-2b1187a0c940
using PyFITS
...
# ╔═╡ 74d16950-aa71-45a2-a61b-153487f48fa7
FIGDIR = "./figures"
...
sim_dir = ENV["DWARFS_ROOT"] * "/simulations/sculptor/mc_orbits/EP2020/"
...
# ╔═╡ 62b8c4e2-926a-49b4-8d15-eef32c4029ea
ana_dir =  "../EP2020/"
...
begin 
	out = lguys.Output("$ana_dir");

	df_peris_apos = read_fits("$ana_dir/peris_apos.fits")
...
obs_props_filename = joinpath(ENV["DWARFS_ROOT"],
	"observations/sculptor/observed_properties.toml"
)

# ╔═╡ c60b4d12-642f-4247-a022-f2c0bb16a092
delta_t = df_peris_apos.t_last_peri

# ╔═╡ f5e9cdc4-6033-4870-84fa-08f537efbdc9
md"""
## double checks
"""
...
# ╔═╡ 6afd6eae-d08d-4b3d-9827-e2748614becc
mean(peris .< df_peris_apos_special.pericentre[2])

# ╔═╡ 4dbac531-e8b9-4225-9f4c-585e1e6716fa
mean(peris .< df_peris_apos_special.pericentre[1])

# ╔═╡ e7e7fcdd-62ca-46f4-b6b1-52133dc05ab3
mean(peris .< df_peris_apos_special.pericentre[3])
...
ϵ = -1/2*lguys.speeds(out[1]) .^2 .- out[1].potential_ext
...
# ╔═╡ 6d01549d-b01a-4158-bf67-82dbc372c1d3
observations_special

# ╔═╡ c48b4e73-480e-4a50-b5fc-db5f6c5b040e
let
	fig = Figure(size=(72*5, 5*72))
	plot_kwargs = Dict(
		:color => :black,
		:alpha => 0.1,
		:markersize => 1,
