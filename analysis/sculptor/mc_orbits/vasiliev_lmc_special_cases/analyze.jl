...
sim_dir = ENV["DWARFS_ROOT"] * "/simulations/sculptor/mc_orbits/vasiliev_lmc/"
...
begin 
	out = lguys.Output("../vasiliev_lmc/");

	df_peris_apos = lguys.read_fits("../vasiliev_lmc/peris_apos.fits")
