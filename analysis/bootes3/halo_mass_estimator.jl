...
obs_props = TOML.parsefile(ENV["DWARFS_ROOT"] * "/observations/bootes3/observed_properties.toml")

# ╔═╡ 330fd1f6-a9a3-46b4-95bc-981615bebcd2
...
begin
	...
	M_L_star_err = 0.2
	MV = obs_props["Mv"]
	MV_err = get(obs_props, "Mv_err", get(obs_props, "Mv_em", NaN))
end
...
# ╔═╡ a09ee5d9-3f8c-45d4-83e3-3cfb2ea03a3d
Vc_m = 10 ^ lMs_to_lVc(log10(Ms_m))

# ╔═╡ d018e137-2659-4993-9f21-b889e40ecdda
Vc_m * V2KMS

# ╔═╡ 54f8287d-7b59-426f-a213-e4ccdacc4887
rc_mean = LilGuys.Ludlow.solve_rmax(Vc_m)
