...
function print_properties(samplename="samples.G_21.mcmc_plummer.csv")
    ...
    print_quantity("Nmemb", samples.N_memb)
...
function (@main)(ARGS)
    print_properties()
    print_properties("samples.G_20.0.mcmc_plummer.csv")
    print_properties("samples.G_20.0.mcmc_sersic.csv")
    print_properties("samples.G_20.0.mcmc_plummer_ell.csv")
end
