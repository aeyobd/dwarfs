...
# ╔═╡ 14e658ed-4a07-4526-9609-b2ee67cbbc43
...
obs_props_filename = ENV["DWARFS_ROOT"] * 
	"/observations/bootes3/observed_properties.toml"
...
σv = obs_props["sigma_v"] .+ randn(length(peris)) * obs_props["sigma_v_em"]
...
# ╔═╡ ce2bb8fe-2236-45d0-a039-c95a157f4abc
[-10.329243, -43.981606, -93.786781]
