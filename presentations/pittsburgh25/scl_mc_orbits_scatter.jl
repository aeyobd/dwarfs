...
@savefig "scl_mc_orbits_xy" compare_x_y_traj(Dict("fiducial" => traj_fiducial), t_min=-10/T2GYR, r_max=120)

# ╔═╡ 0c9eb9da-16c2-4d49-a798-7cd3faa5ec09
let
	fig = compare_x_y_traj(trajectories, t_min=-4/T2GYR, )
...
compare_r_t_traj(trajectories_radii)
