...
let
	include("../../thesis/plots/paper_style.jl")
...
img = FileIO.load(("../yasone/Gaia_s_sky_in_colour.png"))
...
labels = vcat("lmc", "smc", classical_systems,  andromida.key)
...
@savefig "mw_satellites_scl_umi" let
...
# ╔═╡ f17b94b4-0554-481f-9f07-c89bcd12ca80
@savefig "mw_satellites_gaia_only" let
	fig = clear_figure(backgroundcolor=:black, padding=20)
	plot_gaia_image!(fig[1,1])
	ax = Makie.current_axis()
	ax.valign = :top
...
# ╔═╡ 6ca0e36f-b23f-4542-acda-56e57b197f7e
